...
public class KnightsShield extends Item {
    ...
    public int defenseFactor() {
        ...
        if (Dungeon.hero != null && Dungeon.hero.hasTalent(Talent.HARD_SHIELD, Talent.WELL_PROTECTED)) {
            additionalArmor += 2*Dungeon.hero.pointsInTalent(Talent.HARD_SHIELD, Talent.WELL_PROTECTED);
        }
