...
public class BookOfEarth extends SpellBook {
    ...
    public void readEffect() {
        ...
        Buff.affect(Dungeon.hero, Barkskin.class).set(Math.round(Dungeon.hero.lvl/2f*(1 + 0.5f*Dungeon.hero.pointsInTalent(Talent.SPELL_ENHANCE, Talent.RK_WIZARD))), 1);
    }
    ...
    public String info() {
        ...
        if (Dungeon.hero != null && Dungeon.hero.buff(SpellBookCoolDown.class) == null) {
            info += "\n\n" + Messages.get(this, "time",
                    Dungeon.hero.HT,
                    Math.round(Dungeon.hero.lvl/2f*(1 + 0.5f*Dungeon.hero.pointsInTalent(Talent.SPELL_ENHANCE, Talent.RK_WIZARD))));
        }
        return info;
    }
}
